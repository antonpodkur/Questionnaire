...
При проведенні опитувань доцільно враховувати компетентність спеціалістів, оскільки вони мають, як правило, різну кваліфікацію. Існують різні способи оцінки компетентності:
* стаж роботи
* виробничий розряд
У результаті опрацювання даних про експертів, одержують таблиці ранжування, аналогічні тим, що були при ранжуванні факторів. На їх основі перевіряють узгодженість критеріїв компетентності групи експертів та визначають "вагу" кожного з них.
